...
#if LFEDITOR	// JUHOX: don't touch triggers in lens flare editor
...
#if LFEDITOR	// JUHOX: set player tracemask for lens flare editor
...
#if LFEDITOR	// JUHOX: lens flare editor movement
		if (
			cgs.editMode == EM_mlf &&
