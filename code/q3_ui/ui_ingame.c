...
#if LFEDITOR	// JUHOX: grey out the unneeded menu items in edit mode
...
void UI_InGameMenu( void ) {
	...
	uis.cursorx = 319;
	uis.cursory = 80;
	uis.cursor_hx = uis.cursorx * uis.scale + uis.biasX;
	uis.cursor_hy = uis.cursory * uis.scale + uis.biasY;
